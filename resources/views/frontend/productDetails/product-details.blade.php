...
@section('title', "FlipMart | $productDetails->product_name ")
                                ...
                                <div id="owl-single-product">
                                    <div class="single-product-gallery-item" id="slide1">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="#">
                                            <img class="img-responsive" alt="" src="{{ asset('uploads/productImages/'.$productDetails->image) }}" />
                                        </a>
                                    </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="cart-quantity">
                                                <div class="quant-input">
                                                    ...
                                                    <input type="text" value="1" min="1" max="{{ $productDetails->qty }}">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('uploads/productImages/'.$relatedProduct->image) }}" alt=""></a>
                                        </div><!-- /.image -->
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="detail.html">{{ $relatedProduct->product_name }}</a></h3>
                                        <div class="rating rateit-small"></div>
